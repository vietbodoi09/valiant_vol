...
const VALIANT_POOLS = {
  ...
  'Be2eoA9g1Yp8WKqMM14tXjSHuYCudaPpaudLTmC4gizp': { 
    name: 'FOGO-stFOGO', 
    tokenA: 'FOGO',  
    tokenB: 'stFOGO',
    vaultA: '8F5rHhG5TDmq7XRFZXy2HUKfF8X63N7jbp3ZwiKTvLpz',
    vaultB: '5Wh6ZPWS5fXPjgnVErfP5VM6v9zUK2DZwqyHo3Qih5ZR',
  },
...
// ============================================
// VALIANT CLOB API - DISABLED (requires auth)
// ============================================
// async function fetchValiantCLOB(walletAddress, startTime, endTime) {
//   // NOTE: This API requires authentication. CLOB trades are still 
//   // captured via RPC fallback with slightly less accurate pricing.
//   return [];
// }
